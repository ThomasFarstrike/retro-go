...
// Boots into the main OS on OTA 0/1, determined by the partition number that was saved by the main OS before starting retro-go
void rg_boot_main_os() {
#ifdef ESP_PLATFORM
    RG_LOGI("Booting Main OS");
    char *label = "ota_0";
